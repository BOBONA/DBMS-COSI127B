                ...
                <div class="input-group mb-3">
                    ...
                    <ul class="dropdown-menu">
                        <li class="dropdown-item form-check">
                            <input class="form-check-input mx-1" type="checkbox" id="flexCheckDefault" name="search-movies" <?php if (isset($_POST['search-movies'])) echo "checked" ?>>
                            <label class="form-check-label" for="flexCheckDefault">Movie</label>
                        </li>
                        <li class="dropdown-item form-check">
                            <input class="form-check-input mx-1" type="checkbox" id="flexCheckDefault" name="search-tv-shows" <?php if (isset($_POST['search-tv-shows'])) echo "checked" ?>>
                            <label class="form-check-label" for="flexCheckDefault">TV Show</label>
                        </li>
                    </ul>

                    <label for="genre" class="input-group-text">Genre</label>
                    <input type="text" class="form-control" id="genre" name="genre" value="<?php if (isset($_POST['genre'])) echo $_POST['genre'] ?>">

                    <label for="rating-start" class="input-group-text">Rated from</label>
                    <input type="number" class="form-control" placeholder="1" name="rating-start" id="rating-start" value="<?php if (isset($_POST['rating-start'])) echo $_POST['rating-start'] ?>">
                    <label for="rating-end" class="input-group-text">to</label>
                    <input type="number" class="form-control" placeholder="10" name="rating-end" id="rating-end" value="<?php if (isset($_POST['rating-end'])) echo $_POST['rating-end'] ?>">

                    <label for="production" class="input-group-text">Production</label>
                    <input type="text" class="form-control" id="production" name="production" value="<?php if (isset($_POST['production'])) echo $_POST['production'] ?>">

                    <button class="btn btn-outline-secondary" type="submit" name="motion-picture-submitted" formaction="?tab=motion-picture">Search motion pictures</button>
                </div>
            </form>
        </div>
        <div class="tab-pane fade <?php if (isset($_GET["tab"]) && $_GET["tab"] == "people") echo "show active" ?>"
            ...
            <form method="post" action="index.php">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="worked-in" id="worked-in" value="<?php if (isset($_POST['worked-in'])) echo $_POST['worked-in'] ?>">

                    <label for="role" class="input-group-text">Role</label>
                    <input type="text" class="form-control" name="role" id="role" value="<?php if (isset($_POST['role'])) echo $_POST['role'] ?>">

                    <label for="award" class="input-group-text">Award</label>
                    <input type="text" class="form-control" name="award" id="award" value="<?php if (isset($_POST['award'])) echo $_POST['award'] ?>">

                    <button class="btn btn-outline-secondary" type="submit" name="people-submitted" formaction="?tab=people">Search people</button>
                </div>
            </form>
        </div>
        <div class="tab-pane fade <?php if (isset($_GET["tab"]) && $_GET["tab"] == "likes") echo "show active" ?>"
            ...
            <form method="post" action="index.php">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="Title" id="title-like-toggle" name="motion-picture">
